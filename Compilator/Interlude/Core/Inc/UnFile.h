...
CORE_API void appInit( const TCHAR* InPackage, const TCHAR* InCmdLine, FMalloc* InMalloc, FOutputDevice* InLog, FOutputDeviceError* InError, FFeedbackContext* InWarn, FFileManager* InFileManager, FConfigCache*(*ConfigFactory)(), UBOOL RequireConfig, FCodec* Codec=NULL );
...
CORE_API INT appCreateBitmap( const TCHAR* Pattern, INT Width, INT Height, DWORD* Data, FFileManager* FileManager = GFileManager, INT=0 );
CORE_API INT appCreateJpeg(const TCHAR* Pattern, INT Width, INT Height, DWORD* Data, FFileManager* FileManager = GFileManager, INT = 0);
CORE_API void appConvertIntToTime(INT, INT&, INT&, INT&, INT&, INT&);
CORE_API void appLocalTime(INT&, INT&, INT&, INT&, INT&);
...
CORE_API INT appAnsiStrlen( const BYTE* );
...
CORE_API TCHAR* appStrrchr(const TCHAR*, INT);
...
CORE_API TCHAR* appI64toa(SQWORD);
