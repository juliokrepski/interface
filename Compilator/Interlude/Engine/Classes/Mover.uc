...
{
	if(LocVector.X == 0 &&  LocVector.Y == 0 && LocVector.Z == 0)
	{
		//LocVector = Location + (RangeDelta[0]+RangeDelta[1]+RangeDelta[2]+RangeDelta[3])/2*FRand();	
		//LocVector.Z = LocVector.Z +(2*FRand() -1 )*RangeHeight/2;		
		LocVector = Location + (RangeDelta[0]+RangeDelta[1]+RangeDelta[2]+RangeDelta[3])/4;
		LocVector.Z = LocVector.Z + RangeHeight/2;		
	}
}

defaultproperties
{
     RangeHeight=150.000000
     RangeDelta(0)=(X=-80.000000,Y=-80.000000)
     RangeDelta(1)=(X=80.000000,Y=-80.000000)
     RangeDelta(2)=(X=80.000000,Y=80.000000)
     RangeDelta(3)=(X=-80.000000,Y=80.000000)
