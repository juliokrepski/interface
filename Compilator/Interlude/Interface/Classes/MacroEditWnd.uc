...
function OnLoad()
{
    ...
    m_CurIconNum = 1;
    m_CurMacroItemID = 0;
    GetButtonHandle("MacroEditWnd.BtnEditAlldel").SetTooltipCustomType(MakeTooltipSimpleText("Delete all"));
    GetButtonHandle("MacroEditWnd.MacroCopy_Btn").SetTooltipCustomType(MakeTooltipSimpleText("Copy"));
    GetButtonHandle("MacroEditWnd.MacroPaste_Btn").SetTooltipCustomType(MakeTooltipSimpleText("Paste"));
    InitTabOrder();
    HandleMacroList();
    return;
}
